...
NNODE=1 NGPU=4 LOG_RANK=0 bash train.sh \
  ...
  --job.dump_folder /export/work/sabreu/flame/exp/hgrn-sparse-340M-15B/batch${batchsize}.gpu4.sparse90.dyt.steps20480.lr3e-4.dyt \
  ...
  --training.warmup_steps 2048 \
  --training.gradient_accumulation_steps 1 \
  --training.steps 57220 \
