...
NNODE=1 NGPU=2 LOG_RANK=0 bash train.sh \
  ...
  --job.dump_folder /export/work/sabreu/flame/exp/hgrn-sparse-test-340M-10B/batch${batchsize}.gpu2x48.sparse50test.steps20480.lr3e-4 \
  --model.config configs/hgrn_s50_340M_debug.json \
